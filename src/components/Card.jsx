...
export default function Card({ cardContent, buttonContent, blog }) {
    ...
    return (
        <div
            id=""
            className="bg-white max-w-[355px] dark:bg-gray-700 card min-h-[410px] pb-1 shadow shadow-md overflow-hidden rounded rounded-xl "
        >
            ...
            <div className="py-1 pt-2 px-6 h-full">
                ...
                <p className="min-h-[120px] overflow-hidden text-ellipsis my-3 text-[16px] dark:text-white text-gray-700">
                    {blog ? cardContent.excerpt :cardContent.describtion}
                </p>
                <button className="text-[17px] font-semibold bg-indigo-600 transition hover:bg-indigo-700 my-3 text-white px-3 py-1 rounded rounded-full">
                    {" "}
                    <Link
                        href={
                            blog
