        ...
        >
          {isLoading ? (
            ...
            <div className="px-3 md:mt-3">
              ...
              >
                {/* <div className="bg-black text-white dark:bg-white dark:text-black flex flex-col gap-3 p-3 rounded-md font-semibold ">
                  <p className="sub_heading"> Contents </p>
                  <p> 1. Introduction The Entrepreneur Definition;</p>
                  <p> 2. Evolution of the term entrepreneur;</p>
                  <p> 3. who is an entrepreneur;</p>
                  <p> 4. Entrepreneurs and enterprise. </p>
                  <p> 5. Entrepreneur and managers, </p>
                  <p> 6. behavioural pattern of entrepreneurs.</p>
                </div> */}
              </div>
            </div>
          )}
