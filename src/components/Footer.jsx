            ...
            <div className="md:flex md:justify-around ">
              <div className="mb-6 md:mb-0">
                  <Link href="#" className="flex items-center">
                      <span className="self-center text-3xl font-semibold whitespace-nowrap dark:text-white text-indigo-600">  DailyLearn</span>
                  </Link>
              </div>
              <div className="grid space-y-1.5 grid-cols-2  sm:gap-6 sm:grid-cols-3">
                  <div>
                      ...
                      <ul className="text-gray-500 dark:text-gray-400 font-medium">
                          <li className="mb-4">
                              <Link href="/course/marketing" className="hover:underline">Marketing</Link>
                          </li>
                          <li>
